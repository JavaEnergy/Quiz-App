...
import quizData from "../../../data.json"; // Import the JSON file
import "./home.css";
  ...
  return (
    <section className="home">
      <div className="text">
        ...
        <p className={`${mode === "light" ? "" : "dark-mode-p"}`}>
          Pick a subject to get started.
        </p>
      </div>
      <div className="quiz-list">
        <div className={`html list${mode === "light" ? "" : " dark-mode-div"}`}>
          <Link to={"/quiz/html"}>
            <svg
            ...
            <p
              className={`html list${mode === "light" ? "" : " dark-mode-div"}`}
            >
              HTML
            </p>
          </Link>{" "}
        </div>
        <div className={`css list${mode === "light" ? "" : " dark-mode-div"}`}>
          <Link to={"/quiz/css"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="40"
            ...
            <p className={`list${mode === "light" ? "" : " dark-mode-div"}`}>
              CSS
            </p>
          </Link>{" "}
        </div>
        <div className={`list${mode === "light" ? "" : " dark-mode-div"}`}>
